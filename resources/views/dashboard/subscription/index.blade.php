...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('site.subscription')</h1>

            <ol class="breadcrumb">
                <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a></li>
                <li class="active">@lang('site.subscription')</li>
            </ol>
        </section>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (auth()->user()->hasPermission('delete_clients'))
                                            <form action="{{ route('dashboard.subscription.destroy', $client->id) }}" method="post" style="display: inline-block">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
							...
							<form class="pl-3 pr-3" action=""
								...
								<div class="form-group">
									...
									<input class="form-control" type="email" id="emailaddress" name="emailaddress"
										    placeholder="john@deo.com" data-validation="required">
								</div>
								<div class="form-group">
